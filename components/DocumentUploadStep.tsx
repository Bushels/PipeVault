        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-400 mt-2">
              <strong>Paperwork comes with trucker?</strong> You can skip this step and proceed without documents.
            </p>
          </div>
          {onSkip && (
            <button
              ...
              className="flex-shrink-0 inline-flex items-center gap-2 rounded-md bg-gray-700 hover:bg-gray-600 border border-gray-600 px-4 py-2 text-sm font-medium text-white transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            >
