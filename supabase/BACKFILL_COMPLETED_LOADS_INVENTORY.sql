-- ============================================================================
-- BACKFILL SCRIPT: Create Inventory for COMPLETED Loads
-- ============================================================================
--
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE '  Avg Length: % ft', COALESCE(load_record.avg_joint_length_ft, 30.0);
        ...
        IF run_mode = 'EXECUTE' THEN
            DECLARE
                ...
                avg_length_ft NUMERIC := COALESCE(load_record.avg_joint_length_ft, 30.0);
            BEGIN
...
-- ============================================================================
-- Run these queries after backfill to verify results
